...
public class WeatherTool implements Tool {
    ...
    public String description() {
        return "Retorna as condicoes climaticas atuais de uma cidade, consultando a API publica "
                + "Open-Meteo. Action Input: o nome da cidade, ex.: 'Fortaleza'.";
    }

    @Override
    public String execute(String input) {
        String city = input == null ? "" : input.trim();
        if (city.isEmpty()) {
